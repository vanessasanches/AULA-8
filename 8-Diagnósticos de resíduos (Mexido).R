...
hist(residuosAR2, main = "Histograma dos Resíduos")             #Cria histograma com título
hist(residuosAR2, main = "Histograma dos Resíduos", col="Gray") #Cria histograma com título e cor cinza
hist(residuosAR2, main = "Histograma dos Resíduos", col="Gray", breaks=20) #Cria histograma com título, cor cinza e aumenta número de intervalos para 20
                     
                      #Personalizando ainda mais o Histograma (digitar no script)
hist(residuosAR2, main = "Histograma dos Resíduos", col="Gray",breaks = 20,             
               xlab="Resíduos",                                              #Altera o nome do eixo x para Resíduos
